# 🎯 최근접 특징 매칭 기반 얼굴 인식 시스템 v3.0

OpenCV **특징점 추출 및 최근접 매칭** 기술을 사용한 **웹캠** 및 **MP4 비디오 파일** 기반 실시간 얼굴 인식 프로그램입니다.

## 📋 주요 기능

- **🎥 다중 입력 지원**: 웹캠 실시간 영상 + MP4 비디오 파일
- **🔍 실시간 얼굴 검출**: Haar Cascade를 통한 빠른 얼굴 검출
- **🎯 최근접 특징 매칭**: SIFT/ORB 특징점 기반 정밀 매칭 알고리즘
- **🔧 다중 알고리즘 지원**: SIFT, ORB 특징점 검출기 + BF, FLANN 매처
- **🎨 시각적 피드백**: 매칭된 얼굴에 **빨간색 굵은 테두리** 표시
- **📊 실시간 분석**: 특징점 개수, 매칭 점수, 기하학적 검증 결과
- **⏯️ 비디오 제어**: MP4 파일 일시정지/재생 기능
- **🔄 실시간 알고리즘 변경**: 'd' 키로 SIFT ↔ ORB 전환
